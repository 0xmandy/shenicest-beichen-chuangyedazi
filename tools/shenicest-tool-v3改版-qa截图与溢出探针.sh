...
NAMES=(onboard:900 home:1150 company:2000 risk:1400 chat:1100 chat-task:1900 t-shebao:1700 t-kaigongsi:1500 t-aigc:2400 t-app:1400 t-baoshui:1450 policy:1700 fin:1700 opp:1700 cal:1400)
for n in $NAMES; do
  nm=${n%%:*}; ht=${n##*:}
